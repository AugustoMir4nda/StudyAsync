...
urlpatterns = [
    ...
    path('deletar_flashcard/<int:id>', views.deletar_flashcard, name = "deletar_flashcard"), # <int:id> informa que o endereço terá que receber um inteiro após a '/' que é o id.
