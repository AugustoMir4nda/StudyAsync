...
# Criando modelo/tabela para o banco de dados

class Categoria(models.Model):
    nome = models.CharField(max_length=20) #Max de caracteres que a coluna aceita
...
class Flashcard(models.Model):
    ...
    resposta = models.TextField() # um textfield não tem limites de caracteres
    ...
    @property
    def css_dificuldade(self):  #Adicionando o retorno para o html, de propriedades css
